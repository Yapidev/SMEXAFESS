        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul id="sidebarnav">
            <li class="sidebar-item">
              <a class="sidebar-link @if (request()->routeIs('admin.home')) active @endif" href="{{ route('admin.home') }}"
                aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="{{ route('admin.post-queue') }}"
                    class="sidebar-link @if (request()->routeIs('admin.post-queue')) active @endif">
                ...
                <li class="sidebar-item">
                  <a href="{{ route('admin.post-feed') }}"
                    class="sidebar-link @if (request()->routeIs('admin.post-feed')) active @endif">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <i class="ti ti-circle"></i>
                    </div>
                  ...
                  <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
                    ...
                    <div class="d-flex align-items-center">
                      <div class="user-profile-img">
                        <img
                          src="{{ asset(Auth::user()->avatar ? 'storage/' . Auth::user()->avatar : 'dist/images/profile/user-1.jpg') }}"
                    ...
                    <div class="profile-dropdown position-relative" data-simplebar>
                      ...
                      <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                        <img
                          ...
                          style="object-fit: cover" class="rounded-circle" id="photo-profile-master" />
                        <div class="ms-3">
